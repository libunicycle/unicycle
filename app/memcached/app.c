...
void application_init(void) {
    ...
    timer_add(time_sec_from_now(8), timer_fire, (void *)1);
    timer_add(time_sec_from_now(2), timer_fire, (void *)2);
    timer_add(time_sec_from_now(2), timer_fire, (void *)3);
    ...
    if (blk) {
        ...
        blk_write(blk, data, 512, 1024, blk_op_complete, NULL);
    } else {
        printf("No block device found\n");
    }

    printf("Memcached application has started\n");
}
